...
Route::prefix('auth')->controller(AuthController::class)->group(function () {
    ...
    Route::prefix('genre')->middleware('auth:api')->controller(GenreController::class)->group(function () {
    ...
    Route::prefix('album')->middleware('auth:api')->controller(AlbumController::class)->group(function () {
    ...
    Route::prefix('music')->middleware('auth:api')->controller(MusicController::class)->group(function () {
    ...
    Route::prefix('artist')->middleware('auth:api')->controller(ArtistController::class)->group(function () {
    ...
    Route::prefix('choice-music')->middleware('auth:api')->controller(ChoiceMusicController::class)->group(function () {
        ...
        Route::get('/playlist', 'getPlaylist')->name('choice-music.playlist.index');
